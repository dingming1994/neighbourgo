...
class GeoPoint2 with _$GeoPoint2 {
  const factory GeoPoint2({required double lat, required double lng}) = _GeoPoint2;
  factory GeoPoint2.fromJson(Map<String, dynamic> json) => _$GeoPoint2FromJson(json);
}

extension GeoPoint2Ext on GeoPoint2 {
  static GeoPoint2 fromFirestore(GeoPoint gp) => GeoPoint2(lat: gp.latitude, lng: gp.longitude);
}
...
extension TaskModelExt on TaskModel {
  ...
  String get budgetDisplay {
    if (budgetMax != null) return 'S\$$budgetMin–S\$$budgetMax';
    return 'S\$$budgetMin';
  }

  String get urgencyDisplay {
    switch (urgency) {
      case TaskUrgency.asap:     return '🔴 ASAP';
      case TaskUrgency.today:    return '🟡 Today';
      case TaskUrgency.flexible: return '🟢 Flexible';
    }
  }
}
